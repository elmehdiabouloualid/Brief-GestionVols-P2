...
<header>
  ...
  <?php 
        include('header.php') ;
        include('../Controller/RecuperV.php');
  ...
  ?>
     ...
     <!-- Formulaire Passager -->
        ...
        <div id="logbox" style=" width:50%" class="card border-primary rounded-0">
        <div class="card-header p-0">
                        <div class="bg-info text-white text-center py-2">
                            <h3><i class="fa fa-envelope"></i> Passager</h3>
          ...
          <form action="" method="post">
            ...
            <input type="submit" value="Add Passager" name="AddPassager" class="btn btn-info btn-block rounded-0 py-2" id="btn">
