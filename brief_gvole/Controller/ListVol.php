      ...
      $vol_data = $data->selectVol('vol');
       ...
       foreach($vol_data as $vol){
        ...
        <tr>
            ...
            {
               ?>
               <td><a href="annulationVol.php?statusV=Desactive&id_Vol=<?php echo $vol["id_Vol"]; ?>" style="color:black;">
         ...
         <?php   } 
               ...
               <td><a href="annulationVol.php?statusV=Active&id_Vol=<?php echo $vol["id_Vol"]; ?>" style="color:black;">
               <i class="fas fa-exchange-alt" style="color: #67DAD5;"></i>
            </a></td>
            <?php   } ?>
